...
export default function FeaturedCard({ imageUrl, title, description }: FeatureCardProps) {
    return (
        <div className="group relative flex flex-col items-center p-8 bg-white h-80 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-200 transition-all duration-300 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)]">
